...
function doc_keyUp(e) {
    ...
    switch (e.keyCode) {
        ...
        case 133:
            ...
            document.getElementsByClassName("ig-ticket-oneclick_price cell-price btn ig-price-button ig-price-button--buy ig-price-button--active")[0].click()
            break;
         case 129:
         case 124:
            //F18 & F12(HP) -> Sell Open ticket
            document.getElementsByClassName("ig-ticket-oneclick_price cell-price btn ig-price-button ig-price-button--sell ig-price-button--active")[0].click()
            break;
        case 19:
        case 113:
        case 127:
            //F16 & F2(HP) -> Close ticket
